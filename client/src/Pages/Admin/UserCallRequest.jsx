...
const UserCallRequest = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      setLoading(true);
      const response = await axios.get('http://localhost:5000/api/user-queries/get-all-queries');
  ...
  const updateRequestStatus = async (id, status) => {
    ...
    try {
      ...
      await axios.patch(`http://localhost:5000/api/user-queries/update-query/${id}/status`, {
