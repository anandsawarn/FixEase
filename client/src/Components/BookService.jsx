...
const BookService = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/book-service', bookingPayload, {
        headers: {
  ...
  const initiatePayment = async () => {
    ...
    try {
      ...
      const orderResponse = await axios.post('http://localhost:5000/api/v1/create-order', {
        amount: bookingStatus.totalPrice, 
        currency: 'INR'
      });

      // Get Razorpay key
      const keyResponse = await axios.get('http://localhost:5000/api/v1/getKey');
      ...
      const options = {
        ...
        handler: async function(response) {
          ...
          const verificationResponse = await axios.post('http://localhost:5000/api/v1/verify', {
